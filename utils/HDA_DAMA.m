function [acc_per_image,acc_per_class] = HDA_DAMA(trainS_features,trainS_labels,trainT_features,trainT_labels,test_features,test_labels,options);
...
fprintf('d=%d\n',options.ReducedDim);
for iter = 1:num_iter
    P = DAMA(trainS_features,trainT_features,trainS_labels,trainT_labels,options);
